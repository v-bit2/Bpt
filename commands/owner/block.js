/**
 * Block Command - Block a user (works in DM or with mention/reply in groups)
 */
...
module.exports = {
  ...
  aliases: [],
  category: 'owner',
  description: 'Block a user (use in their DM, or mention/reply in a group)',
  usage: '.block [@user|reply]',
  ownerOnly: true,
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      await sock.sendMessage(extra.from, {
        text: `✅ @${pn.split('@')[0]} has been blocked.`,
        mentions: [pn]
      }, { quoted: msg });
    } catch (error) {
